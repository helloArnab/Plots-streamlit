...
st.header("1. Charts with radom numbers")
...
df = pd.read_csv("D:\Data Science\Streamlit\iris.csv")
st.dataframe(df)

st.subheader("2.2 Bar Graph Plot with Matplotlib")
...
st.header("3. Multiple Graphs in one colums")
...
fig = plt.figure(figsize = (15,8))
sns.boxenplot(data = df, x = 'species', y = 'petal_length')
st.pyplot(fig)
